...
def _get_python_call(python_script_name, params):
    str = python_script_name + " with "
    for param in params:
        str = str + param + "=${" + param + "}" + " "
    return str

def get_script(python_script_name, fields, params, param_order=None):
    '''
    ...
    subs = {
        ...
        'num_jobs': num_jobs,
        'call_function': _get_python_call(python_script_name, param_order)
    }
...
def save_script(filename, python_script_name, fields, params, param_order=None):
    '''
    ...
    script_str = get_script(python_script_name, fields, params, param_order)
